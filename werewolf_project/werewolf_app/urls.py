...
urlpatterns = [
    ...
    path('game/<int:gameID>/phaseSummary', views.phaseSummary),
    path('game/<int:gameID>/update', views.updateGame),
    path('game/<int:gameID>/start', views.startGame),
    path('game/<int:gameID>/suggestRoles', views.suggestRoles),
    ...
    path('game/<int:gameID>/forceRole/<int:roleID>', views.forceRole),
    path('game/<int:gameID>/forceKill/<int:roleID>', views.forceKill),
    path('game/<int:gameID>/forceAlive/<int:roleID>', views.forceAlive),
    path('game/<int:gameID>/playerInfo', views.playerInfo),
    path('game/<int:gameID>/postGameInfo', views.postGameInfo),
    path('game/<int:gameID>/postGameGraph', views.postGameGraph),
